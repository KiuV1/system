...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=524591160736481292&permissions=8&scope=bot')
  .setDescription(`**
  New Server Add !KiuV..Bot ✅
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("441344394625548300").sendEmbed(embed)
});
...
const adminprefix = "-v";
const devs = ['441344394625548300','441344394625548300'];
client.on('message', message => {
